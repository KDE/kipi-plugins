...
void CDArchiving::readSettings(void)
{
  ...
  m_configDlg->setPublisher( m_config->readEntry("Publisher", i18n("KIPI [digikam.sourceforge.net]")) );
...
void CDArchiving::createHead(QTextStream& stream)
{
    ...
    // PENDING(blackie) Update URL
    stream << "<meta name=\"Generator\" content=\"Albums HTML interface for CD archiving generated by KIPI"
                             ...
                             const KURL& url, const QString& imageFormat)
{
    ...
    Temp = i18n("Albums archiving created with <a href=\"http://digikam.sourceforge.net\">KIPI</a>"
                " on %1").arg(today);
    stream << Temp << endl;
    stream << "</p>" << endl;
    stream << "</body>\n</html>\n" << endl;
...
void CDArchiving::createBodyMainPage(QTextStream& stream, KURL& url)
{
    ...
    stream << "<img src=\"valid-html401.png\" alt=\"" << Temp << "\" height=\"31\" width=\"88\" title=\""
           << Temp <<  "\" />" << endl;
    Temp = i18n("Albums archiving created with <a href=\"http://kipi.sourceforge.net\">KIPI</a>"
                " on %1").arg(today);
    stream << Temp << endl;
    stream << "</p>" << endl;
    stream << "</body>\n</html>\n" << endl;
...
bool CDArchiving::createPage(const QString& imgGalleryDir , const QString& imgName,
    ...
    if ( pagesDir.exists() && file.open(IO_WriteOnly) )
      ...
      valid =  i18n("Images gallery created with <a href=\"http://digikam.sourceforge.net\">KIPI</a> "
                    "on %1").arg(today);
