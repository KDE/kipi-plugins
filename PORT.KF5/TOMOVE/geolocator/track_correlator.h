...
Q_SIGNALS:
    ...
    void signalItemsCorrelated(const KIPIGeolocatorPlugin::TrackCorrelator::Correlation::List& correlatedItems);
    void signalAllItemsCorrelated();
    void signalCorrelationCanceled();

private Q_SLOTS:

    void slotThreadItemsCorrelated(const KIPIGeolocatorPlugin::TrackCorrelator::Correlation::List& correlatedItems);
...
Q_DECLARE_METATYPE(KIPIGeolocatorPlugin::TrackCorrelator::Correlation::List)
