      ...
      d(new Private())
{
    ...
    connect(d->trackCorrelator, SIGNAL(signalItemsCorrelated(KIPIGeolocatorPlugin::TrackCorrelator::Correlation::List)),
            this, SLOT(slotItemsCorrelated(KIPIGeolocatorPlugin::TrackCorrelator::Correlation::List)));
...
void GPSCorrelatorWidget::slotItemsCorrelated(const KIPIGeolocatorPlugin::TrackCorrelator::Correlation::List& correlatedItems)
{
