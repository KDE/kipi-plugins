...
SlideShowSettingsWidget::SlideShowSettingsWidget(QWidget* parent, Qt::WFlags flags)
...
void SlideShowSettingsWidget::updateData(int time, QString transition, QString transSpeed, QString effect)
{
