                          ...
                          i18n("Effect options"), Ok|Cancel, Ok, false)
{
    ...
    if (EffectType == i18n("Adaptative threshold"))
       {
       ...
       QWhatsThis::add( m_latWidth, i18n("<p>Select here the value who represents the width "
       ...
       QWhatsThis::add( m_latHeight, i18n("<p>Select here the value who represents the height of "
       ...
       QWhatsThis::add( m_latOffset, i18n("<p>Select here the value who represents the mean offset.") );
    ...
    if (EffectType == i18n("Charcoal"))
       ...
       QWhatsThis::add( m_charcoalRadius, i18n("<p>Select here the value who represents the "
       ...
       QWhatsThis::add( m_charcoalDeviation, i18n("<p>Select here the value who represents the "
    ...
    if (EffectType == i18n("Detect edges"))
       ...
       QWhatsThis::add( m_edgeRadius, i18n("<p>Select here the value who represents the radius of "
                                           "the pixel neighborhood. Radius defines the radius of the "
                                           "convolution filter. Use a radius of 0 and the algorithm selects "
    ...
    if (EffectType == i18n("Emboss"))
       ...
       QWhatsThis::add( m_embossRadius, i18n("<p>Select here the value who represents the radius of the "
                                             "pixel neighborhood. For reasonable results, radius should be "
                                             "larger than deviation. Use a radius of 0 and the algorithm "
       ...
       QWhatsThis::add( m_embossDeviation, i18n("<p>Select here the value who represents the standard "
    ...
    if (EffectType == i18n("Implode"))
       ...
       QWhatsThis::add( m_implodeFactor, i18n("<p>Select here the value who represents the extent of "
                                              "the implosion.") );
    ...
    if (EffectType == i18n("Paint"))
       ...
       QWhatsThis::add( m_paintRadius, i18n("<p>Select here the value who represents the radius of "
    ...
    if (EffectType == i18n("Shade light"))
       ...
       QWhatsThis::add( m_shadeAzimuth, i18n("<p>Select here the value who represents the azimuth of "
       ...
       QWhatsThis::add( m_shadeElevation, i18n("<p>Select here the value who represents the elevation of "
    ...
    if (EffectType == i18n("Solarize"))
       ...
       QWhatsThis::add( m_solarizeFactor, i18n("<p>Select here the value who represents the percent "
    ...
    if (EffectType == i18n("Spread"))
       ...
       QWhatsThis::add( m_spreadRadius, i18n("<p>Select here the value who represents the random "
    ...
    if (EffectType == i18n("Swirl"))
       ...
       QWhatsThis::add( m_swirlDegrees, i18n("<p>Select here the value who represents the tightness of "
    ...
    if (EffectType == i18n("Wave"))
       ...
       QWhatsThis::add( m_waveAmplitude, i18n("<p>Select here the value who represents the amplitude of "
                                              "the sine wave.") );
       m_label_waveAmplitude->setBuddy( m_waveAmplitude );
       dvlay->addWidget( m_waveAmplitude );

       QLabel *m_label_waveLenght = new QLabel (i18n("Lenght:"), box);
       dvlay->addWidget( m_label_waveLenght );
       m_waveLenght = new KIntNumInput(100, box);
       m_waveLenght->setRange(0, 200, 1, true );
       QWhatsThis::add( m_waveLenght, i18n("<p>Select here the value who represents the wave length "
                                           "of the sine wave.") );
